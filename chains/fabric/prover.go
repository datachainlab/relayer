...
func (pr *Prover) QueryLatestHeight() (int64, error) {
	h := pr.getCurrentHeight()
	return int64(h.RevisionHeight), nil
}
...
func (*Prover) CreateTrustedHeader(dstChain core.LightClientIBCQueryier, srcHeader core.HeaderI) (core.HeaderI, error) {
	return nil, nil
}
