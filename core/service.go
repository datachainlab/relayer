...
func StartService(ctx context.Context, st StrategyI, src, dst *Chain, relayInterval time.Duration) error {
...
func NewRelayService(st StrategyI, src, dst *Chain, sh SyncHeadersI, interval time.Duration) *RelayService {
	return &RelayService{
		src:      src,
		dst:      dst,
		st:       st,
